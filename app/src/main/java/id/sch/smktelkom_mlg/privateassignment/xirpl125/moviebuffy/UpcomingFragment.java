...
public class UpcomingFragment extends Fragment {
    ...
    private static final String URL_DATA = "https://api.themoviedb.org/3/movie/upcoming?api_key=1fcf9e5f6d9c565825c3c7435ddfffea";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ab) {
                        ...
                        try {
                            ...
                            adapter = new UpcomingAdapter(upcomingItems, getActivity().getApplicationContext());
